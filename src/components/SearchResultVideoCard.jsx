    ...
    return (
        <Link to={`/video/${video?.videoId}`}>
            <div className="flex flex-col md:flex-row mb-8 md:mb-3 lg:hover:bg-white/[0.1] rounded-xl md:p-4">
                {/* Set the thumbnails and time duration of each search video */}
                <div className="relative flex shrink-0 h-48 md:h-28 lg:h-40 xl:h-48 w-full md:w-48 lg:w-64 xl:w-80 rounded-xl bg-slate-800 overflow-hidden">
                    ...
                    {/* Set the thumbnails of each search video */}
                    <img
                        className="h-full w-full object-cover"
                        src={video?.thumbnails[0]?.url}
                    />
                    {/* Set the time duration of each search video */}
                    {video?.lengthSeconds && (
                ...
                <div className="flex flex-col ml-4 md:ml-6 mt-4 md:mt-0 overflow-hidden">
                    {/* Set the title of each search video */}
                    <span className="text-lg md:text-2xl font-semibold line-clamp-2 text-white">
                        {video?.title}
                    </span>

                     {/* Set the description of each search video */}
                    ...
                    <div className="hidden md:flex items-center">
                         ...
                         {/* Set the author avtar of each search video*/}
                        ...
                        <div className="flex flex-col">
                             {/* Add the channel title and if the channel is varified the add the varified tick icon*/}
                            ...
                            <div className="flex text-sm font-semibold text-white/[0.7] truncate overflow-hidden">
                                ...
                                {/* Add the dot(.) between  video veiws and publishedtime*/}
